...
;;usei como base uma configuração pronta para o uso de latex e uso de pdf só implementando coisad como o evil mode e atalhos para deixar semelhante com o vim e uso do simle para executar usando o sbcl lisp
;;creditos ao usuario aeghn que me basei como modelo 
...
;; Exibição de pares de parênteses
...
;; Suporte a Git avançado
(use-package git-gutter
  :config
  (global-git-gutter-mode +1))

;; Realce de indentação
...
;; Codeium - Complemento AI
(use-package codeium
  :init
  (add-hook 'prog-mode-hook #'codeium-mode))
